      ...
      <div className="relative flex h-[90vh] w-full max-w-[520px] flex-col overflow-hidden rounded-3xl bg-[#0f0f13] shadow-2xl ring-1 ring-white/10">
        ...
        <div className="flex flex-1 flex-col items-center justify-center gap-4 px-8">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="ml-2 text-xs text-white/50">YAMI is speaking…</span>
          </div>
        </div>

        {/* Student PiP (picture-in-picture) */}
        <div className="absolute bottom-32 right-5 h-24 w-16 overflow-hidden rounded-2xl bg-zinc-800 ring-2 ring-white/10 shadow-lg flex items-center justify-center">
          ...
          <span className="absolute bottom-1.5 left-0 right-0 text-center text-[9px] text-white/50">You</span>
        </div>
        ...
        <div className="flex items-center justify-center gap-5 pb-8 pt-4">
          ...
          <button
            ...
            className={[
              "flex h-14 w-14 flex-col items-center justify-center gap-1 rounded-full transition",
          ...
          <button
            className="flex h-14 w-14 flex-col items-center justify-center gap-1 rounded-full bg-white/10 text-white transition hover:bg-white/20"
            title="Transcript"
          >
            <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
